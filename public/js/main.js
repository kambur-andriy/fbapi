...
var showMessage = function showMessage(message) {
    var modal = $('<div />').attr('id', 'custom-message').addClass('modal').append($('<div />').addClass('modal-content').html(message)).append($('<div />').addClass('modal-footer').append($('<a />').attr('href', '').addClass('modal-action modal-close waves-effect waves-green btn-flat').html('Close')));
...
$(document).ready(function () {
    ...
    $('#login_form').on('submit', function (event) {
        ...
        axios.post('/account/login', qs.stringify(credentials)).then(function (response) {
    ...
    $('#register_form').on('submit', function (event) {
        ...
        axios.post('/account/register', qs.stringify(credentials)).then(function () {
    ...
    $('#password_form').on('submit', function (event) {
        ...
        axios.post('/account/reset-password', qs.stringify(credentials)).then(function () {
    ...
    $('#reset_password_form').on('submit', function (event) {
        ...
        axios.post('/account/save-password', qs.stringify(credentials)).then(function (response) {
    ...
    $('#contact_form').on('submit', function (event) {
        ...
        axios.post('/contact-us', qs.stringify({
